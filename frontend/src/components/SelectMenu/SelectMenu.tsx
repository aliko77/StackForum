   ...
   return (
      <Listbox value={props.value} onChange={props.onChange}>
         <div className="relative mt-1">
            ...
            <Listbox.Options className="absolute mt-1.5 max-h-60 w-full overflow-auto rounded-sm bg-white dark:bg-gray-700 py-1 shadow-lg ring-1 ring-black ring-opacity-5 text-sm outline-none">
