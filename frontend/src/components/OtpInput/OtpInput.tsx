      ...
      <div>
         {arr.map((_, index) => {
            return (
               <input
                  key={index}
                  className={`m-2 border border-secondary-500 dark:border-primary-500 h-10 w-10 text-center rounded-sm text-black dark:text-gray-100 dark:bg-night-800 outline-none`}
                  type="text"
                  inputMode="numeric"
