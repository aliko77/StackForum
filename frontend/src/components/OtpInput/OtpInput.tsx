      ...
      <div>
         {arr.map((_, index) => {
            return (
               <input
                  key={index}
                  className={`m-2 border dark:border-rose-400 border-indigo-400 h-10 w-10 text-center rounded-sm text-black dark:text-gray-100 dark:bg-night-100 outline-none`}
                  type="text"
                  inputMode="numeric"
