            ...
            <div className="flex flex-auto flex-row space-x-3 items-center overflow-auto no-scrollbar">
               <NavLink to="/profil">
                  <div className="flex items-center text-sm text-gray-700 dark:text-gray-300 hover:text-rose-500 dark:hover:text-violet-500">
                     ...
                     <span className="mx-1.5">Profilim</span>
                  </div>
               </NavLink>
               <NavLink to="/kontrol-paneli">
                  <div className="flex items-center text-sm text-gray-700 dark:text-gray-300 hover:text-rose-500 dark:hover:text-violet-500">
                     ...
                     <span className="mx-1.5">Panelim</span>
                  </div>
               </NavLink>
               <div>
                  <div className="flex items-center text-sm text-gray-700 dark:text-gray-300 hover:text-rose-500 dark:hover:text-violet-500">
                     ...
                     <span className="mx-1.5">Popüler Konular</span>
                  </div>
               </div>
               <div>
                  <div className="flex items-center text-sm text-gray-700 dark:text-gray-300 hover:text-rose-500 dark:hover:text-violet-500">
                     ...
                     <span className="mx-1.5">Yeni Konular</span>
                  </div>
               </div>
               <div>
                  <div className="flex items-center text-sm text-gray-700 dark:text-gray-300 hover:text-rose-500 dark:hover:text-violet-500">
                     ...
                     <span className="mx-1.5">Yeni Mesajlar</span>
                  </div>
               </div>
            </div>
         </div>
